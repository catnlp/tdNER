...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='model/example/lstmcrf_data') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='model/example/lstmcrf_data.dset') # catnlp
    parser.add_argument('--train', default='data/raw/example/train_data')
    parser.add_argument('--test', default='data/raw/example/test_data')
