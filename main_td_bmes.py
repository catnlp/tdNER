...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='model/intelligence/lstmcrf_bmes') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='model/intelligence/lstmcrf_bmes.dset') # catnlp
    parser.add_argument('--train', default='data/raw/intelligence/train.bmes')
    parser.add_argument('--test', default='data/raw/intelligence/test.bmes')
